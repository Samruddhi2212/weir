...
--
-- Credentials below are placeholders. SeaweedFS in docker-compose.yml
-- has no -s3.config identity file, so it has no configured access
-- key/secret. If this fails on auth, that's a real finding, not a bug
-- in this file.
